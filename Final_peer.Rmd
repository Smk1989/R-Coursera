...
While it is obvious that quality is a big deciding factor in the pricing of a house, I wanted to know the exact effect it has on the price. We can figure out two things from the side by side boxplots.
